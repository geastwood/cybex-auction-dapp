                ...
                <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
                    ...
                    <View style={styles.getStartedContainer}>
                        ...
                        <TouchableOpacity onPress={this.props.onStorePress}>
                            <Text>StoreAction</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={this.props.onSagaPress}>
                            <Text>SagaAction</Text>
                        </TouchableOpacity>
                        {this.props.auctions.map((auction, i) => <Text key={i}>{auction.name}</Text>)}

                        <Text style={styles.getStartedText}>what not</Text>
...
export default connect(
    ...
    {
        onStorePress: () => storeActions.auctionReceive([{ name: 'fei' }]),
